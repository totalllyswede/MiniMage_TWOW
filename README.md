...
* **Minimap Button**: Drag and position a customizable minimap button for easy access.
...
* **Turtle WOW Portals Added**: Includes special portals unique to Turtle WOW.
* **Announcements**: Optional greetings and notifications in chat when the addon loads.

## Installation

1. Download or clone the repository into your `Interface/AddOns/` folder.
...
Feel free to fork, submit issues, or make pull requests. Suggestions for new portals or teleport locations are welcome!
